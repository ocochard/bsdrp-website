...
- [Validating OpenVPN's low-latency servers selection patch](examples/validating-openvpn-s-low-latency-servers-selection-patch.md)
...
- [Dropping packets at high rate](examples/dropping-packets-at-high-rate.md)
...
- HP ProLiant DL360p Gen8 (Intel Xeon E5-2650, 8 cores)
  - [Forwarding performance lab of a HP ProLiant DL360p Gen8 with 10-Gigabit Chelsio T540-CR](examples/forwarding-performance-lab-of-a-hp-proliant-dl360p-gen8-with-10-gigabit-with-10-gigabit-chelsio-t540-cr.md)
...
- Netgate RCC-VE 4860 (quad core Intel Atom C2558 with 2 Intel i211 and 4 Intel i350 NIC):
...
- [Maximum BSDRP features lab](examples/maximum-bsdrp-features-lab.md) (used for testing BSDRP before publish release)
- [Testing grappath the ASCII network diagram tool](examples/graphpath.md)
- [FreeBSD performance regression lab](examples/freebsd-performance-regression-lab.md)

If you want to easly generate a router lab, follow this [How to build a BSDRP router lab](examples/how-to-build-a-bsdrp-router-lab.md).
